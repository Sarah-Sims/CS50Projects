...
person *create_family(int generations)
{
    ...
    struct person *personpointer = malloc(sizeof(person));
    ...
    if (generations > 1)
    {
        ...
        personpointer->parents[0] = parent0;
        personpointer->parents[1] = parent1;

        int randomOne = rand() % 2;
        char alleleOne = parent0->alleles[randomOne];

        int randomTwo = rand() % 2;
        char alleleTwo = parent1->alleles[randomTwo];

        personpointer->alleles[0] = alleleOne;
        personpointer->alleles[1] = alleleTwo;
